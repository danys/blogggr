...
public class SessionServiceImpl implements SessionService{
    ...
    @Override
    public SessionDetails createSession(SessionPostData sessionData) throws ResourceNotFoundException, DBException, WrongPasswordException, UnsupportedEncodingException{
