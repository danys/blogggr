                ...
                <div className="col-md-4">
                    <div className="well">
                        ...
                        <div className="form-group">
                            ...
                            <div className="radio">
                                <label>
                                    <input type="radio" name="searchVisibility" id="searchVisibilityOnlyGlobal" value="onlyGlobal"/>
                                        Only global
                                </label>
                            </div>
                            <div className="radio">
                                <label>
                                    <input type="radio" name="searchVisibility" id="searchVisibilityOnlyFriends" value="onlyFriends"/>
                                        Only friends
                                </label>
                            </div>
                            <div className="radio">
                                <label>
                                    <input type="radio" name="searchVisibility" id="searchVisibilityOnlyMe" value="onlyMe"/>
                                        Only your posts
                                </label>
                            </div>
                        </div>
